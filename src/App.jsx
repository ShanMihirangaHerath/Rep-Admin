...
import { LayoutDashboard, Users, Map, FileUp, Settings as SettingsIcon, LogOut, Menu, X, ClipboardCheck, FileText, Wallet } from "lucide-react";
...
function App() {
  ...
  // 🚀 Screen size එක බලලා Mobile නම් Sidebar එක ඉබේම close කරනවා
  useEffect(() => {
    const handleResize = () => {
  ...
  // 🚀 Mobile එකේදී Tab එකක් click කරාම Sidebar එක ඉබේම වැහෙන්න හදපු function එක
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex overflow-hidden">
      ...
      {/* 🚀 Mobile Overlay (Sidebar එක open වෙද්දි පිටිපස්ස කළු වෙන එක) */}
      {isSidebarOpen && (
        <div 
      ...
      `}>
        <div className="h-16 flex items-center justify-between px-4 border-b border-white/10">
          {/* Mobile වලදී Logo එක හැමතිස්සෙම පේනවා, Desktop වල open නම් විතරයි පේන්නේ */}
